...
<html>
	...
	<body class="container">
		...
		<form class="form-group" method="get" action="results.php" style="text-align:center">
	...
	<footer style="position: absolute; bottom: 0px; padding-right:200px; padding-bottom:50px;">
	    <h3>
